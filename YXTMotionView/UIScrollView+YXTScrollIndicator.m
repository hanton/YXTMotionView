//
//  UIScrollView+YXTScrollIndicator.m
//  YXTMotionViewDemo
//
...
#import "UIScrollView+YXTScrollIndicator.h"
#import <objc/runtime.h>

static const char viewScrollIndicatorKey;
static const char backgroundViewScrollIndicatorKey;
static const CGFloat CRScrollIndicatorHeight = 0.0f;//1.0f;
static const CGFloat CRScrollIndicatorBottomSpace = 0.0f;//20.0f;
static const CGFloat CRScrollIndicatorDefaultWidth = 0.0f;//20.0f;
static const CGFloat CRScrollIndicatorLeftRightThreshold = 0.0f;//16.0f;

@implementation UIScrollView (YXTScrollIndicator)
...
- (void)yxt_enableScrollIndicator
{
...
- (void)yxt_refreshScrollIndicator
{
...
- (void)yxt_disableScrollIndicator
{
    @try {
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context
{
    if (self.contentSize.width > 0.0f) {
        [self yxt_refreshScrollIndicator];
    }
}
